(function() {
	...
	// (source pixel data + on-site sample 1 + on-site sample 2) / 3
	var paintingFeatureVec = [
		[
			(0.6391872287819984 + 0.5239178480856143 + 0.45415345209409114) / 3,
			(0.7296098844665485 + 0.8035832549572408 + 0.8636653459875832) / 3,
			(-0.2210092938228081 + -0.2122352393865333 + -0.1934467522025942) / 3,
			(-0.0057990776804819014 + -0.18288613771136766 + -0.08154524631309412) /
				3,
			(0.07796537770425577 + -0.007276636778967386 + 0.05952207760079806) / 3,
			(0.06443419644979827 + -0.03492785653904117 + 0.014582909012194951) / 3
		],
		[
			(-0.3593924173784146 + -0.3030924568415693 + -0.27620639981601575) / 3,
			(-0.611915816235142 + -0.590167832630535 + -0.5946857824325745) / 3,
			(-0.498629075974555 + -0.4975375806689763 + -0.49879828486061084) / 3,
			(0.35716016633879705 + 0.4556467533062926 + 0.47164734468790415) / 3,
			(0.17718492626963767 + 0.1053991137797178 + 0.13449453064454686) / 3,
			(0.2980055137889341 + 0.30589264583678 + 0.2811110391693084) / 3
		],
		[
			(0.029811998557934285 + 0.371124618444706 + 0.4097668608718038) / 3,
			(-0.026711550707909825 + 0.014116647559362346 + 0.08296265015680267) / 3,
			(-0.08275810799682715 + -0.0063422619469603895 + 0.03209503984168276) / 3,
			(-0.5852691556893755 + -0.6937616213594271 + -0.6677383131842012) / 3,
			(-0.22537870909798688 + -0.18576689831741677 + -0.17844034729589875) / 3,
			(-0.7734424905870613 + -0.5883982374018616 + -0.5886109193606802) / 3
		]
	];

	var paintingMatchThreshold = [1.2, 1.2, 1.2];
